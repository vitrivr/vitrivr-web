...
export const API_BASE = import.meta.env.VITRIVIR_API_BASE || "http://localhost:7070";
const config: OpenAPIConfig = {...OpenAPI, BASE: API_BASE, ENCODE_PATH: OpenAPI.ENCODE_PATH ?? ((p: string) =>
